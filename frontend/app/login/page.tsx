...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
       ...
       * this is a new user who must complete onboarding.
       */
      ...
      /*
       * Preferences exist:
       * user can continue directly to dashboard.
       */
      ...
      /*
       * Unexpected backend error while checking preferences.
       */
      setError(
        "Login succeeded, but your preferences could not be checked."
      );
    } catch (error) {
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-lg dark:border-gray-800 dark:bg-gray-900">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="mt-5">
            ...
            <div className="relative">
              <input
                ...
                required
                disabled={isLoading}
                className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 pr-16 text-gray-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500"
              />
              ...
              <button
                ...
                disabled={isLoading}
                className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 transition-colors hover:text-blue-600 disabled:cursor-not-allowed disabled:opacity-60 dark:text-gray-400 dark:hover:text-blue-400"
              >
                {showPassword ? (
                  <svg
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-3 font-semibold text-white transition duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:bg-blue-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:transform-none disabled:opacity-60 dark:focus:ring-offset-gray-900"
          >
            {isLoading ? (
              <>
