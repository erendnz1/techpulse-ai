...
export default function SecurityPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/news/security?skip=0&limit=10${regionParam}`,
      {
        headers: {
  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-10 lg:py-10">
      <h1 className="text-2xl font-bold sm:text-3xl">Security Alerts</h1>
      ...
      {!loading && filteredSecurityAlerts.length === 0 && (
        <div className="mt-8 rounded-2xl border border-gray-200 bg-white/70 p-8 text-center dark:border-gray-700 dark:bg-gray-800/60">
          <h3 className="text-lg font-semibold">No security alerts found</h3>
        ...
        <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-2">
          {filteredSecurityAlerts.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex flex-wrap items-center gap-3 bg-gradient-to-br px-4 py-4 sm:px-6 text-white ${meta.colors}`}
                >
                ...
                <div className="p-6">
                  ...
                  <h2 className="line-clamp-3 text-xl font-semibold text-gray-900 dark:text-white">
                    {item.title}
                  </h2>
