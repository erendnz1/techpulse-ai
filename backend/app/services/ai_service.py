...
def detect_category(text: str) -> str | None:
    ...
    "stable diffusion", "midjourney","copilot studio",
"cursor",
"windsurf",
"ollama",
"langchain",
...
"openrouter",
    ...
    "xai",
        ...
        "Framework": [
            ...
            "flask", "fastapi", "spring boot", "spring", "asp.net", ".net","react native",
"vite",
"tailwind",
"typescript",
"javascript",
...
"netlify",
    ...
    "cloud",
        ...
        "DevOps": [
            ...
            "gitlab ci", "ci/cd", "helm", "argo cd","github runner",
"github workflow",
"podman",
"grafana",
"prometheus",
